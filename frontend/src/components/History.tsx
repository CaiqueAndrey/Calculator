...
import { DivHistory,HeaderHistory, ListHistory } from "../styles/components/History";

export function History (){
    const { history, resetHistory } = useContext(CalculatorContext);
        ...
        <>
            <DivHistory>
                <HeaderHistory>
                    ...
                    <span className="spanTwo" onClick={()=> resetHistory()} >
